...
RSYNC_CMD="rsync -l -i -r -t -v --progress --stats --modify-window=1 --backup --backup-dir=$TARGET/$DIFF/ -e ssh $SOURCE $TARGET_MACHINE:$TARGET/full"
#RSYNC_CMD="rsync --delete -l -i -r -t -v --progress --stats --modify-window=1 --backup --backup-dir=$TARGET/$DIFF $SOURCE/ $TARGET/full/"
